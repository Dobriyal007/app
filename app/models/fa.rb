class Fa < ApplicationRecord
  ...
  MODELS = ['SSE-SJB4', 'SSE-SAW5', 'SSE-SCG6', 'SSE-SCT9', 'SSE-SDF8', 'SSE-SCV2', 'SSE-SDS5', 'SSE-SFW9',
    ...
    'SSE-JJ7', 'SSE-SJA4', 'SSE-SJZ3', 'SSE-SKK6', 'SSE-SJJ6', 'SSE-SLF7', 'SSE-SKG5', 'MIX-SGK6',
    'MIX-SJZ5', 'MIX-SHR5', 'BBK-SJV5', 'BBK-SKC1', 'BBK-SJQ5', 'BBK-SJQ6', 'BBK-SJV6', 'BBK-SJQ6',
    'BBK-SHX4', 'BBK-SHV2', 'BBK-SHD2', 'BBK-SFC8', 'OPO-SCP5', 'OPO-SCR2', 'OPO-SDY7', 'OPO-SACJ1',
